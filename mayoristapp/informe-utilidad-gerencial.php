                                                    ...
                                                    <div class='panelesBloqueInforme '>
                                                                    ...
                                                                    <div class="tituloFecha">
                                                                        ...
                                                                        <div id="buscaFecha"  class="control w100p">
                                                                            ...
                                                                            <label for="fechaDesde"  class="parametros"><i class="fa fa-calendar fa-lg fa-fw"></i></label><input type="date" name="fechaDesde" id="fechaDesde" required="required">    al
                                                                            <label for="fechaHasta"  class="parametros"><i class="fa fa-calendar fa-lg fa-fw"></i></label><input type="date" name="fechaHasta" id="fechaHasta" required="required">
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class='panelesBloqueInforme'>
                                                                    ...
                                                                    <div class="control">
                                                                        ...
                                                                        <ul name="listaPv" id="listaPv" class="listaSeleccionado">
                                                                            <li id="1"  data-valor="Todos"><i class="fas fa-check-square fa-lg fa-fw"></i>Punto venta: Todos <a class="borrarLi" rel="listaPv|1" href="#" title="Eliminar de la lista"><i class="fa fa-trash fa-lg"></i></a></li>
                                                                        </ul>
                                                    ...
                                                    <div class="panelesBloqueInforme">
                                                                        ...
                                                                        <div class="control w100p">
                                                                            ...
                                                                            <ul name="listaFiltro" id="listaFiltro" class="listaSeleccionado">
