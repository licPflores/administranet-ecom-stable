...
$Conf['Titulo']="Compras por periodo";
$Conf['modulo']="Compras";
?>
<!DOCTYPE HTML>
<html lang="es-AR">
...
//                        console.log($(this).attr("alt"));
        ...
        var jqxhr =  $.ajax({
                            type: "GET", 
                            url: "informes-json/compras_periodo.php", 
                            async: false,
                            data:{
                    "ajax" : "true",
			 ...
			 $('#myTableVentasRubro').text('No puedo Cargar Datos');
			 $('#myTableVentasRubro1').hide();
             })
...
//var dataObject=  jQuery.parseJSON(jqxhr);
 /*************************/
   ...
   $('iframe').attr('src', $('iframe').attr('src'));
    ...
    tabla.DataTable({
	columns: dataObject[0].columns,	
"aaData" : dataObject[0].datosFormateado,
ajax: {dataSrc:''}
...
/*--------------
Tabla oculta pero con decimales
--------------*/
...
//CHart
var grafico = $('#grafico0');
if(grafico.attr('src')==null){
 grafico.attr('src', 'moto/datatables2.php');
 }else
 {
 ...
 grafico.css( "height",450);
  ...
  grafico = $('#grafico1');
   if(grafico.attr('src')==null){
 grafico.attr('src', 'moto/gchart2.php');
   }else
	 {
		 alert(grafico.attr('src'));
			grafico.attr('src', grafico.attr('src'));
...
<!-- Inicia Graficos -->			
<iframe id="grafico0" height=0 width="100%" frameborder=0></iframe>                
<iframe id="grafico" height=0 width="100%" frameborder=0></iframe>
<iframe id="grafico1" height=0 width="100%" frameborder=0></iframe> 
<!-- Fin Graficos -->	
                    <div class="control">
