...
class Jcart
{
    ...
    private function promocion_art_cant_intervalo($idArt = null, $cantidad = null)
    {
        ...
        //            print_r($_SESSION);
        //            echo"</pre>";
        $link = mysqli_connect($servidor, 'administranet', 'a7v8xx0805', $base);
    ...
    private function calcularImpuestoInterno($arrParametros)
    {
        ...
        if ($arrParametros['tipo'] == 'Porcentaje') {
            $valorImpuesto = (($arrParametros['cantidad'] * $arrParametros['neto']) * $arrParametros['porcentaje']) / 100;
        }
        // Porcentaje Minimo
        if ($arrParametros['tipo'] == 'Porcentaje - Minimo') {
            $montoCalculado = (($arrParametros['cantidad'] * $arrParametros['neto']) * $arrParametros['porcentaje']) / 100;
    ...
    public function display_carrito_pedido_mobil()    {
        ...
        if ($this->itemCount > 0) {
            ...
            foreach ($this->get_contents() as $item) {
                ...
                // echo tab(7) . $item['qty']."\n";
                echo tab(7) . "<input id='jcartItemQty-{$item['key']}' name='jcartItemQty[]' size='4' type='text' value='{$item['qty']}' style='width:40px;' />\n";
                echo tab(6) . "</td>\n";
                //                echo tab(6) . "<td class='jcart-item-price'>\n";
                //                if ($item['descTotal'] != 0) {
        ...
        if ($tipoUsuario == "vendedor") {
            ...
            echo tab(5) . "<div class='importe' title='Seleccionar Forma de entrega'><i class='fa fa-truck fa-lg fa-fw'></i> <select name='formaEntrega' id='formaEntrega'>";
            ...
            //                echo tab(5) . "</div>";
            echo tab(5) . "<div class='importe' title='Ingresar hora de envio'><i class='far fa-clock fa-lg fa-fw'></i>    <input type='text' id='jcart-detalle' required='required' placeholder='hh:mm o detalle' name='jcart-detalle' class='detallePedido'>";
            echo tab(5) . "</div>";
            /* logistica */
            /* domicilios */
    ...
    public function display_carrito_pedido_desktop(){
        ...
        //echo "limite<pre>".print_r($this->config["limiteRenglon"])."</pre>";
        $limiteDespacho = 500;
        $validoLimiteDespacho = true;
        $valorPedido = $this->subtotal + $this->subtotalImpInt;
        ...
        if ($tipoUsuario == "vendedor") {
            ...
            if ($isCheckout !== true) {
                ...
                echo tab(4) . "<button type='submit' id='jcart-checkout' name='jcartCheckout' class='botonNuevo grande azul'>"
                    . "Continuar <i class='fa fa-check'></i>"
                    . "</button>\n";
                //			echo tab(4) . "<input type='$inputType' $src id='jcart-checkout' name='jcartCheckout' class='jcart-buttons-ok' alt='{$config['text']['checkout']}' title='{$config['text']['checkout']}' />\n";
            }
            ...
            //                echo tab(5) . "<div class='texto'>";
            //                echo tab(5) . "</div>";
            echo tab(5) . "<div class='importe' title='Ingresar hora de envio'><i class='fas fa-clock fa-fw fa-lg'></i>    <input type='text' id='jcart-detalle' required='required' placeholder='hh:mm entrega detalle' name='jcart-detalle' class='detallePedido'>";
            echo tab(5) . "</div>";
            /* logistica */
            /* domicilios */
            //                    echo var_dump($permisoClientesDom);
            if ($permisoClientesDom == 'Si') {
                echo tab(6) . '<div class="importe" ><i class="fa fa-map-marker fa-lg fa-fw"></i><select name="domicilio_entrega" id="domicilio_entrega" required=required title="Ingresar Domicilio de entrega">'
                    . '<option value="">- domicilios -</option>';
                foreach ($_SESSION['domicilios_cliente'] as $dom) {
                    echo tab(7) . '<option value="' . $dom["idDom"] . '|' . $dom["id_zona"] . '">'
                        . $dom["Calle"] . ', '
                        . $dom["NroCalle"] . ', '
    ...
    public function display_carrito_presupuesto_mobil(){
        ...
        echo tab(4) . "<div class='jcart-panel-tres'>";
        //                echo tab(5) . "<div class='texto'></div>"
        echo tab(5) . "<div class='texto' title='Seleccionar Forma de entrega'><i class='fa fa-truck fa-lg fa-fw'></i></div><div class='importe'> <select name='formaEntrega' id='formaEntrega'>";
        echo tab(6) . "<option value='Retira cliente despacho'>RETIRO EN TIENDA</option>";
        if ($validoLimiteDespacho == true) {
            if ($valorPedido > $limiteDespacho) {
                echo tab(6) . "<option selected value='Envía por despacho'>ENVIAR A DOMICILIO</option>";
            }
        } else {
            echo tab(6) . "<option selected value='Envía por despacho'>ENVIAR A DOMICILIO</option>";
        ...
        //                echo tab(5) . "<div class='texto'>";
        //                echo tab(5) . "</div>";
        echo tab(5) . "<div class='texto' title='Ingresar hora de envio'><i class='far fa-clock fa-lg fa-fw'></i></div> "
            . "<div class='importe'>    <input type='text' id='jcart-detalle' required='required' placeholder='hh:mm horario de entrega' name='jcart-detalle' class='detallePedido'>";
        echo tab(5) . "</div>";
        /* logistica */
        /* domicilios */
        //                echo var_dump($permisoClientesDom);
        if ($permisoClientesDom == 'Si') {
            echo tab(6) . '<div class="texto" ><i class="fa fa-map-marker fa-lg fa-fw"></i></div><div class="importe"><select name="domicilio_entrega" id="domicilio_entrega" required=required title="Ingresar Domicilio de entrega">'
                . '<option value="" selected>- calle, nro,depto - prov - dep -distr- zona - </option>';
            foreach ($_SESSION['domicilios_cliente'] as $dom) {
                echo tab(7) . '<option value="' . $dom["idDom"] . '|' . $dom["id_zona"] . '">'
                    . $dom["Calle"] . ', '
                    . $dom["NroCalle"] . ', '
            ...
            echo tab(6) . '<div class="texto" ><i class="fa fa-map-marker fa-lg fa-fw"></i> </div>'
                . '<div class="importe"><select name="domicilio_entrega" id="domicilio_entrega" title="Ingresar Domicilio de entrega"> '
                . '<option value="" selected>- calle, nro,depto - prov - dep -distr- zona - </option>';
            foreach ($_SESSION['domicilios_cliente'] as $dom) {
                echo tab(7) . '<option value="' . $dom["idDom"] . '|' . $dom["id_zona"] . '">'
                    . $dom["Calle"] . ' '
    ...
    public function display_carrito_presupuesto_desktop() {
        ...
        //                echo tab(5) . "<div class='texto'>";
        //                echo tab(5) . "</div>";
        echo tab(5) . "<div class='importe' title='Ingresar hora de envio'><i class='fas fa-clock fa-lg fa-fw'></i>    <input type='text' id='jcart-detalle' required='required' placeholder='hh:mm horario de entrega' name='jcart-detalle' class='detallePedido'>";
        echo tab(5) . "</div>";
        /* logistica */
        /* domicilios */
        //                echo var_dump($permisoClientesDom);
    ...
    public function display_carrito_remito_talonario_mobil(){
        ...
        if (isset($_POST[$add])) {
            ...
            $itemAdded = $this->add_item($id, $name, $price, $qty, $url, $iva, $tipoIva, $impIva, $alicuota, $impInterno, $neto, 0, $descPor, $promo, $promoCant, $promoPorc, $promoTipo, $impInternoT, $lote, $idLote, $nombLote, $deposito, $entregado);
            // If not true the add item function returns the error type
            if ($itemAdded !== true) {
                $errorType = $itemAdded;
                switch ($errorType) {
