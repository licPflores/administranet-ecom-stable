...
<head>
    ...
    <title>Cobranzas | administraNET</title>
    ...
    $('#filtrarPor').change(function() {
         ...
         if(validacion){
            ...
            $.ajax({
                    ...
                    url:'ajax/json_datos_informe_cobranzas.php',
                    method:'GET',
                    data:datos,
                    success: function(response){
                       ...
                       let nombre = 'Cliente'
                    if(informe == 'cobranzasVendedor'  || informe == 'comprobantesCobrarVendedor'){nombre = 'Vendedor'}
...
<div id="wrapper">
        ...
        ?>
            ...
            <div class="paneles filtroInformes">
                <h1>Cobranzas<span><i id="parametrosInformes" class="fas fa-angle-up fa-lg fa-fw" aria-hidden="true"></i></span></h1>
                    ...
                    <div class="control">
                        <label for="agrupoPor" class="parametros">Informes:  </label>
                            <select name="agrupoPor" id="agrupoPor" required="required">
                                ...
                                <option value="cobranzasCliente">Cobranzas por cliente</option>
                                <option value="cobranzasVendedor">Cobranzas por vendedor</option>
                                <option value="comprobantesCobrarCliente">Comprobantes a cobrar por cliente</option>
                                <option value="comprobantesCobrarVendedor">Comprobantes a cobrar por vendedor</option>
...
<!-- <div class="paneles" id="contiene-tabla" style="overflow:auto"> -->
    ...
    <h1>Estadísticas de cobranzas <i id="expandir" class="fa fa-expand fa-lg fa-fw" title="expandir"></i> </h1>
