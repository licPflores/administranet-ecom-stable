...
//                    alert(response);
     ...
     var chkFactura= 
             function(){
                 var claseChk='fa fa-check-square fa-2x i-chk-dev' , claseCuadro='fa fa-square fa-2x i-chk-dev';
...
<body>
    <div id="wrapper">
        ...
        <div class="paneles filtroInformes">   
                            ...
                            <h1>Parametros <span><i class="fas fa-angle-up fa-lg fa-fw" id="verFiltros"></i></span></h1>
                    ...
                    <div class="paneles" id="contiene-tabla"  > 
                            ...
                            <label class="parametros" for="totalRecibo">Total Neto: </label>
                                        <i class="fa fa-dollar fa-1x" ></i>
                                        <input type="number" name="totalNeto" id="totalNeto" readonly="readonly">
                                        <br>  
                            <label class="parametros" for="totalIva">Total Iva: </label>
                                        <i class="fa fa-dollar fa-1x" ></i>
                                        <input type="number" name="totalIva" id="totalIva" readonly="readonly">
                                        <br> 
                            <label class="parametros" for="totalTotal">Total Imputado: </label>
                                        <i class="fa fa-dollar fa-1x" ></i>
                                        <input type="number" name="totalTotal" id="totalTotal" readonly="readonly">
                                        <br>
                    </div>                    
                    ...
                    <div class="panelesBloqueInformeAccion">
                        <span class="centro w100p">
                            <button title="Aceptar" alt="Aceptar" type="button" id="botAceptar" name="botAceptar" class="botonNuevo grande azul">
                                <i class="fas fa-check fa-lg fa-fw"></i> Aceptar
                            </button>
                        </span>
                    </div>  
