...
//            vamos a mostrar el pedido completo con sus lineas de pedido.
            //$pedidos = array();
//            Pedido.VencFact.Caption = DataConsulta.Recordset.Fields!Vencimiento
//             Pedido.ImporteTotal.Caption = Format(DataConsulta.Recordset.Fields!ImporteVenta, "##,##0.00")
//             Pedido.Iva1.Caption = Format(DataConsulta.Recordset.Fields!Iva1, "##,##0.00")
//             Pedido.Iva2.Caption = Format(DataConsulta.Recordset.Fields!Iva2, "##,##0.00")
//             Pedido.Alic1 = Format(DataConsulta.Recordset.Fields!Alicuota1, "##,##0.0")
//             Pedido.Alic2 = Format(DataConsulta.Recordset.Fields!Alicuota2, "##,##0.0")
//             Pedido.Exento = Format(DataConsulta.Recordset.Fields!Exento, "##,##0.00")
//             Pedido.Subtotal1 = Format(DataConsulta.Recordset.Fields!Subtotal1, "##,##0.00")
//             Pedido.Subtotal2 = Format(DataConsulta.Recordset.Fields!Subtotal2, "##,##0.00")
//             Pedido.SubtotalGral = Format(DataConsulta.Recordset.Fields!SubtotalGral, "##,##0.00")
//             Pedido.SubTotalDesc1 = Format(DataConsulta.Recordset.Fields!SubTotalDesc1, "##,##0.00")
//             Pedido.SubTotalDesc2 = Format(DataConsulta.Recordset.Fields!SubTotalDesc2, "##,##0.00")
//             Pedido.SubtotalDesc = Format(DataConsulta.Recordset.Fields!SubtotalDesc, "##,##0.00")
//             Pedido.PorDesc1 = Format(DataConsulta.Recordset.Fields!PorDesc1, "##,##0.00")
//             Pedido.ImpDesc1 = Format(DataConsulta.Recordset.Fields!ImpDesc1, "##,##0.00")
//             Pedido.LIVA1 = Pedido.LIVA1 & "  " & DataConsulta.Recordset.Fields!Alicuota1 & " %"
//             Pedido.LSubtotal1 = Pedido.LSubtotal1 & "  " & DataConsulta.Recordset.Fields!Alicuota1 & " %"
//             Pedido.LIVA2 = Pedido.LIVA2 & "  " & DataConsulta.Recordset.Fields!Alicuota2 & " %"
//             Pedido.LSubtotal2 = Pedido.LSubtotal2 & "  " & DataConsulta.Recordset.Fields!Alicuota2 & " %"
//echo "<pre>";
//echo print_r($_POST);
//echo "</pre>";
            if(isset($_POST['codigomovimiento'])){
                ...
                $pedido = mysql_fetch_object($hacerPed);
                $renglones = array();
                ...
                $hacerRenglon = mysql_query($sqlRenglon) or die('no puedo recuperar el renglon'.mysql_error());
                while($renglon=  mysql_fetch_object($hacerRenglon)){
                    $renglones[]=$renglon;
                }
...
$muestraR .='                   <li><strong>Domicilio: </strong>'.$pedido->Calle.' Nº'. $pedido->NroCalle .' depto :'.$pedido->Depto.   '</li>';
...
$muestraR .='       Comprobante generado por:<br>Tel:0261-4248404 /www.sticuyo.com';
$muestraR .='       </div>';
$muestraR .='   </div>';
$muestraR .='</div>';
