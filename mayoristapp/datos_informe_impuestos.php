...
<head>
    ...
    <title>Impuestos | administraNET</title>
...
$(document).ready(function(){
         ...
         if(validacion){
            ...
            $.ajax({
                    ...
                    url:'ajax/json_datos_informe_impuestos.php',
                    method:'GET',
                    data:datos,
...
<div id="wrapper">
        ...
        ?>
            ...
            <div class="paneles filtroInformes">
                <h1>Impuestos<span><i id="parametrosInformes" class="fas fa-angle-up fa-lg fa-fw" aria-hidden="true"></i></span></h1>
    ...
    <div class="control">
        <label for="agrupoPor" class="parametros">Informes:  </label>
            <select name="agrupoPor" id="agrupoPor" required="required">
                ...
                <option value="impuestoPeriodo">Impuestos por período</option>
...
</div><div class="panelesBloqueInforme">
...
<!-- <div class="paneles" id="contiene-tabla" style="overflow:auto"> -->
    ...
    <h1>Estadísticas de impuestos <i id="expandir" class="fa fa-expand fa-lg fa-fw" title="expandir"></i> </h1>
