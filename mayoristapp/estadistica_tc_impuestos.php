...
$Conf['Titulo']='Estadistica Tabla Cruzada impuestos';
$Conf["modulo"]="Pagos";
...
//                        console.log($(this).attr("alt"));
        ...
        var jqxhr =  $.ajax({
                            type: "GET", 
                            url: "informes-json/estadistica_tc_impuestos.php",
                            async: false,
                            data:{
                    "ajax" : "true",
...
console.log(dataObject[0].SQL);
tabla.append('</tr></tfoot>');
}
//$('#myTableVentasRubro tfoot tr th').addClass("numeros");
