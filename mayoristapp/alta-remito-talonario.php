...
$iconoDisabled = 0;
$comprobante="REM talonario";
//echo "<pre>";
//print_r($_SESSION);
//print_r($_SESSION["sel_factura"]);
//echo "</pre>";
if(!isset($_SESSION['cliente'])){
    header('Location:listado-clientes.php?frm=2&cartel=1');
}
...
<html lang="es">
    <head>
            ...
            <title> Remito Talonario | administraNET e-com </title>
                                ...
                                <form method="post" action="" class="jcart">
                                    ...
                                    <div class="contiene-renglon">
                                            ...
                                            <label id="envRemitoLabel" for="envRemito"> 
                                                <input type="radio" name="entregarItem" value="0" id="envRemito" ><strong> Remito </strong>
                                            </label>
...
<!--				<p><small>Having trouble? <a href="jcart/server-test.php">Test your server settings.</a></small></p>-->
                        ...
                        <?php  if(isset($_REQUEST['buscaOferta'])):?>
                                    <script>
                                        $(document).ready(function() {
                                            $('#queArticulo').val('');    
                                            $('#queArticuloId').val('<?php echo $_REQUEST['IDArt'];?>');
