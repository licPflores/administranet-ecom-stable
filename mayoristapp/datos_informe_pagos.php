...
<head>
    ...
    <title>Pagos | administraNET</title>
    ...
    $('#filtrarPor').change(function() {
         ...
         if(validacion){
            ...
            $.ajax({
                    ...
                    url:'ajax/json_datos_informe_pagos.php',
                    method:'GET',
                    data:datos,
                    success: function(response){
                        ...
                        if(informe == 'gastosPeriodo'){nombre = 'Gastos'}
...
<div id="wrapper">
        ...
        ?>
            ...
            <div class="paneles filtroInformes">
                <h1>Pagos<span><i id="parametrosInformes" class="fas fa-angle-up fa-lg fa-fw" aria-hidden="true"></i></span></h1>
                        ...
                        <div class="control">
                            <label for="agrupoPor" class="parametros">Informes:  </label>
                                <select name="agrupoPor" id="agrupoPor" required="required">
                                    ...
                                    <option value="pagosProveedor">Pagos por proveedor</option>
                                    <option value="comprobantesPagarProveedor">Comprobantes a pagar por proveedor</option>
                                    <option value="gastosPeriodo">Gastos por período</option>
            ...
            <label for="verInforme" class="parametros">Valores por:</label>
                <select name="verInforme" id="verInforme" required="required">
                    <option value="monto" selected="selected">Monto ($)</option>    </select>
            </div>
...
<!-- <div class="paneles" id="contiene-tabla" style="overflow:auto"> -->
    ...
    <h1>Estadísticas de pagos <i id="expandir" class="fa fa-expand fa-lg fa-fw" title="expandir"></i> </h1>
